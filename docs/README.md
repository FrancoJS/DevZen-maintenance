...
- Los tickets implementan creación, listado, detalle, edición propia `NEW`, asignación inicial transaccional, inicio de mantención y registro técnico en `IN_PROGRESS`. Resolución, cierre y congelamiento permanecen pendientes; el detalle vigente se mantiene en [IMPLEMENTATION_CHECKLIST.md](IMPLEMENTATION_CHECKLIST.md).
