...
- Los tickets implementan creación, listado, detalle, edición propia `NEW`, asignación inicial transaccional y consultas de disponibilidad/mantención actual. Inicio, información técnica, resolución, cierre y congelamiento permanecen pendientes; el detalle vigente se mantiene en [IMPLEMENTATION_CHECKLIST.md](IMPLEMENTATION_CHECKLIST.md).
